...
@TableName("crm_customer_profile_history")
public class CustomerProfileHistory {
    ...
    @Version private Integer versionNum;

    public Long getId() { return id; } public void setId(Long v) { this.id = v; }
    public Long getProfileId() { return profileId; } public void setProfileId(Long v) { this.profileId = v; }
    public Integer getVersion() { return version; } public void setVersion(Integer v) { this.version = v; }
    public String getOperatedBy() { return operatedBy; } public void setOperatedBy(String v) { this.operatedBy = v; }
    public OffsetDateTime getOperatedAt() { return operatedAt; } public void setOperatedAt(OffsetDateTime v) { this.operatedAt = v; }
    ...
    public Integer getVersionNum() { return versionNum; } public void setVersionNum(Integer v) { this.versionNum = v; }
}
