...
public class SysDictController {
    ...
    public Result<?> pageDictTypes(
        ...
        wrapper.eq(SysDictType::getDeleted, 0).orderByAsc(SysDictType::getSortOrder);
        com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<SysDictType> finalWrapper = wrapper;
        page = dictService.getBaseMapper().selectPage(page, finalWrapper);
